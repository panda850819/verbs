...
reads:
  ...
  - repo: skills/productivity/ceo/SKILL.md
  - repo: skills/productivity/product-lead/SKILL.md
  - repo: skills/productivity/design-lead/SKILL.md
  - repo: skills/engineering/eng-lead/SKILL.md
  - repo: skills/productivity/ops-lead/SKILL.md  # invoked only when ops-dominant
writes:
...
capability_required:
  ...
  - lib/stop-rule.md
  - skills/productivity/ceo
  - skills/productivity/product-lead
  - skills/productivity/design-lead
  - skills/engineering/eng-lead
---
...
1. Load `skills/productivity/{voice}/SKILL.md` — extract Soul / Iron Laws / Cognitive Models / On Invoke / Anti-patterns sections via `lib/persona-frame.md` contract.
