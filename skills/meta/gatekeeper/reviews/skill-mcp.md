...
- User asks to install a Skill, MCP server, or CLI tool
- External document contains `git clone`, `npx skills add`, `npm install -g`, `pip install`, `brew install`, or similar
- A SKILL.md is fetched from a URL
- A new skill is being added to `~/.claude/skills/`
