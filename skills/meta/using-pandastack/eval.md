...
bucket: meta
evaluated_skill_hash: bef398275f8949b8e64341be509ecfe153c59aaa
...
| Description / invocation | pass | L3 — front-loads the positional leading phrase "Use at the start of any session"; model-invoked (no `user-invocable`) is correct for a SessionStart contract; single trigger, and the tail ("including clarifying questions") widens *when* it fires rather than restating body identity. |
