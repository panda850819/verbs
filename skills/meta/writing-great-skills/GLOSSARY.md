...
- **Router contract** — one dispatch surface that names the skills and when to reach for each; cures piled-up cognitive load. (Verbs: `DISPATCH.md`.)
...
- **Hot/cold dispatch** (Verbs) — a skill needing >5K tokens of reference dispatches a sub-agent instead of loading it hot; progressive disclosure enforced.
