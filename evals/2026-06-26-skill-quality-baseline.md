...
- The 5 persona skills (`ceo`, `eng-lead`, `ops-lead`, `product-lead`, `design-lead`) and `lib/persona-frame.md` were removed (2026-06-29, PR #100/#101); `debug`, `ui`, `boardroom` were added. Any persona row in the historical scorecard below describes a skill that no longer ships. Current surface: 23 skills.
