...
| `/verbs:sprint-planning` | core | Repair unreliable planning inputs through Grill and relevant planning skills, then plan one Sprint Goal and select ready work after a human approval gate. |
...
| v1 gate | Observable pass condition | Current evidence (2026-08-12) | Status |
|---|---|---|---|
