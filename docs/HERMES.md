# Panda Verbs on Hermes

Hermes supports selective manual import only. Panda Verbs does not ship a
...
ln -sfn /absolute/path/to/panda-verbs/skills/productivity/grill \
  "$HOME/.hermes/skills/grill"
ln -sfn /absolute/path/to/panda-verbs/skills/engineering/review \
...
and tool translation. Imported skills do not receive Panda Verbs reference
